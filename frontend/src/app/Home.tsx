...
export default function Home() {
  ...
  const levels = [
    ...
    },
    {
      ...
      completed: false,
      locked: !unlockedLevels.includes(4),
    ...
    },
    {
      ...
      completed: false,
      locked: !unlockedLevels.includes(5),
    ...
    >
      ...
      <div className="relative flex-1 overflow-hidden z-10">
        ...
        {fullname && (
          ...
          >
            <p className="text-cyan-300 text-lg font-semibold">{fullname}</p>
          </motion.div>
        )}
        ...
        {levels.map((level) => (
          <LevelMarker
            ...
            showUnlockAnimation={
              showUnlockAnimation && levelToUnlock === level.id
            }
          />
        ))}
      </div>
                ...
                {loadingLeaderboard ? (
                  ...
                  <div className="p-6">
                    {leaderboardData.length === 0 ? (
                      <div
                        className="text-center text-cyan-400 py-8"
                        style={{ fontFamily: "Rajdhani, sans-serif" }}
                      >
                        No data available
                      </div>
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div
                                ...
                                style={{ fontFamily: "Rajdhani, sans-serif" }}
                              >
                                {player.fullname?.firstname}{" "}
                                {player.fullname?.lastname || ""}
                              </div>
                              <div
