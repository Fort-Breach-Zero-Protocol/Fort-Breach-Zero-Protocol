    ...
    >
      ...
      <div className="relative z-10 flex-1 overflow-y-auto">
        <div className="max-w-5xl mx-auto px-8 md:px-12 py-12 space-y-10">
          ...
          >
            <h1
              className="text-4xl md:text-5xl font-bold text-cyan-400 mb-3"
            ...
            {sections.map((section, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <ul
                    className="space-y-2 text-cyan-200 text-base leading-relaxed"
                    style={{ fontFamily: "Rajdhani, sans-serif" }}
                  >
          ...
          >
            ...
            >
              <li>
                Survival Platform: 50% chance to survive when stepping on it.
              </li>
              <li>
                Gate: One player must press the red button; then the gate opens
                and others can pass.
              </li>
              <li>
                Portal: Entering a green portal turns your unit into an enemy
                and it comes out from another portal.
              </li>
            </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <figure className="bg-[#0b203a]/60 p-3 rounded border border-cyan-400/20">
                ...
                />
                <figcaption className="mt-2 text-sm text-cyan-200">
                  Survival Platform (50% survival)
                </figcaption>
              </figure>
              <figure className="bg-[#0b203a]/60 p-3 rounded border border-cyan-400/20">
                <ImageWithFallback
              ...
              <figure className="bg-[#0b203a]/60 p-3 rounded border border-cyan-400/20">
                ...
                />
                <figcaption className="mt-2 text-sm text-cyan-200">
                  Portal converts your unit to enemy
                </figcaption>
              </figure>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <figure className="bg-[#0b203a]/60 p-3 rounded border border-cyan-400/20">
                ...
                />
                <figcaption className="mt-2 text-sm text-cyan-200">
                  Enemy emerges from linked portal
                </figcaption>
              </figure>
            </div>
          </motion.section>
